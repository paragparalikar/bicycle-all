...
public class FallingStrengthIndicatorBuilder implements IndicatorBuilder {
    ...
    public Indicator build() {
        return indicatorCache.fallingStrength(sourceIndicatorBuilder.build(), integerIterator.value());
    }

    @Override
    public Indicator buildDefault() {
        return indicatorCache.fallingStrength(sourceIndicatorBuilder.buildDefault(), integerIterator.defaultValue());
    }
