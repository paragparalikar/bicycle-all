...
public class StandardDeviationIndicatorBuilder implements IndicatorBuilder {
    ...
    public Indicator build(IndicatorCache indicatorCache) {
        return indicatorCache.stdDev(sourceIndicatorBuilder.build(indicatorCache), integerIterator.value());
    }

    @Override
    public Indicator buildDefault(IndicatorCache indicatorCache) {
        return indicatorCache.stdDev(sourceIndicatorBuilder.buildDefault(indicatorCache), integerIterator.defaultValue());
    }
