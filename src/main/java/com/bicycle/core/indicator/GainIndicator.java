...
public class GainIndicator implements Indicator {
    ...
    public GainIndicator(int symbolCount, int timeframeCount, Indicator indicator, IndicatorCache indicatorCache) {
    ...
    public void onBar(Bar bar) {
        ...
        float value = Math.max(0, Float.isNaN(previousIndicatorValue) || Float.isNaN(indicatorValue) ? 
                0 : indicatorValue - previousIndicatorValue);
